...
3. Границы дня — московские (UTC+3): день начинается в 21:00 UTC предыдущего дня.
...
- **T-2**: Новые integration-тесты нового модуля через его публичный интерфейс —
  ...
  московская граница дня в `raw_messages_for_day` (сообщение в 22:00 UTC
  относится к следующему московскому дню).
